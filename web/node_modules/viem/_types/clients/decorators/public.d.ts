...
export type PublicActions<TTransport extends Transport = Transport, TChain extends Chain | undefined = Chain | undefined, TAccount extends Account | undefined = Account | undefined> = {
     ...
     */
    getBlock: <TIncludeTransactions extends boolean = false, TBlockTag extends BlockTag = 'latest'>(args?: GetBlockParameters<TIncludeTransactions, TBlockTag> | undefined) => Promise<GetBlockReturnType<TChain, TIncludeTransactions, TBlockTag>>;
    /**
     ...
     */
    estimateFeesPerGas: <TChainOverride extends Chain | undefined = undefined, TType extends FeeValuesType = 'eip1559'>(args?: EstimateFeesPerGasParameters<TChain, TChainOverride, TType> | undefined) => Promise<EstimateFeesPerGasReturnType>;
    /**
     ...
     */
    getLogs: <const TAbiEvent extends AbiEvent | undefined = undefined, const TAbiEvents extends readonly AbiEvent[] | readonly unknown[] | undefined = TAbiEvent extends AbiEvent ? [TAbiEvent] : undefined, TStrict extends boolean | undefined = undefined, TFromBlock extends BlockNumber | BlockTag | undefined = undefined, TToBlock extends BlockNumber | BlockTag | undefined = undefined>(args?: GetLogsParameters<TAbiEvent, TAbiEvents, TStrict, TFromBlock, TToBlock> | undefined) => Promise<GetLogsReturnType<TAbiEvent, TAbiEvents, TStrict, TFromBlock, TToBlock>>;
    /**
     ...
     * // 10000000n
     */
    estimateMaxPriorityFeePerGas: <TChainOverride extends Chain | undefined = undefined>(args?: EstimateMaxPriorityFeePerGasParameters<TChain, TChainOverride> | undefined) => Promise<EstimateMaxPriorityFeePerGasReturnType>;
    /**
