...
export type TransactionRequest<TQuantity = bigint, TIndex = number> = TransactionRequest_<TQuantity, TIndex> & {
...
export type ZkSyncTransactionRequestEIP712<TQuantity = bigint, TIndex = number> = Omit<TransactionRequestBase<TQuantity, TIndex>, 'type'> & ExactPartial<FeeValuesEIP1559> & {
...
export type ZkSyncTransactionRequest<TQuantity = bigint, TIndex = number> = TransactionRequest<TQuantity, TIndex> | ZkSyncTransactionRequestEIP712<TQuantity, TIndex>;
...
export type ZkSyncRawBlockTransactions = {
    commonData: {
        ...
        } & CommonDataRawBlockTransaction) | undefined;
        L2?: {
            nonce: number;
            fee: ZkSyncFee<Hex>;
