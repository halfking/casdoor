...
var EXTENSION_DOWNLOAD_URL = {
    CHROME: 'https://chrome.google.com/webstore/detail/tally-ho/eajafomhmkipbjmfmhebemolkcicgfmd',
...
var Onboarding = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        event.source.postMessage({ type: 'tallyho:registrationCompleted' }, event.origin);
                        this.stopOnboarding();
                        return [3 /*break*/, 8];
                    case 5:
     ...
     */
    Onboarding.isTallyHoInstalled = function () {
        return Boolean(window.ethereum && window.ethereum.isTally);
    };
    ...
    Onboarding._detectBrowser = function () {
        var browserInfo = Bowser__default["default"].parse(window.navigator.userAgent);
