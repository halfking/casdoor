...
var useStyle = (0, _makeStyle.default)('layout', function (token) {
  return (0, _defineProperty2.default)({}, ".previewer-layout".concat(token.rootCls, "-layout"), (0, _defineProperty2.default)((0, _defineProperty2.default)({}, "".concat(token.rootCls, "-layout-header"), {
  ...
  }), "".concat(token.rootCls, "-layout-sider"), (0, _defineProperty2.default)((0, _defineProperty2.default)({
    padding: 0,
    borderInlineEnd: "".concat(token.lineWidth, "px ").concat(token.lineType, " ").concat(token.colorSplit),
    transition: "all ".concat(token.motionDurationSlow),
    overflow: 'visible !important'
  }, "".concat(token.rootCls, "-btn").concat(token.rootCls, "-btn-circle.previewer-sider-collapse-btn"), {
    position: 'absolute',
...
var Previewer = function Previewer(_ref2) {
  ...
  var handleTokenClick = (0, _react.useCallback)(function (tokenName) {
    ...
    (_tokenPanelRef$curren = tokenPanelRef.current) === null || _tokenPanelRef$curren === void 0 || _tokenPanelRef$curren.scrollToToken(tokenName);
  }, []);
      ...
      return {
        ...
        onThemeChange: function onThemeChange(newTheme) {
          if (themeEntity.key === (theme === null || theme === void 0 ? void 0 : theme.key)) {
            _onThemeChange === null || _onThemeChange === void 0 || _onThemeChange(newTheme);
          } else {
