...
var useStyle = (0, _makeStyle.default)('TokenPanelProAlias', function (token) {
  return {
    '.token-panel-pro-color-alias': (0, _defineProperty2.default)((0, _defineProperty2.default)({
      display: 'flex',
    ...
    }, ".token-panel-pro-alias-collapse".concat(token.rootCls, "-collapse"), (0, _defineProperty2.default)((0, _defineProperty2.default)({}, "> ".concat(token.rootCls, "-collapse-item > ").concat(token.rootCls, "-collapse-content > ").concat(token.rootCls, "-collapse-content-box"), {
      paddingBlock: '0'
    }), "> ".concat(token.rootCls, "-collapse-item"), (0, _defineProperty2.default)({}, "> ".concat(token.rootCls, "-collapse-header"), (0, _defineProperty2.default)((0, _defineProperty2.default)({
      alignItems: 'center',
      padding: '8px 16px'
    }, "> ".concat(token.rootCls, "-collapse-header-text"), {
      flex: 1,
    ...
    return /*#__PURE__*/_react.default.createElement(Panel, {
      header: /*#__PURE__*/_react.default.createElement("div", {
        ...
        onClick: function onClick(e) {
          e.stopPropagation();
          onTokenSelect === null || onTokenSelect === void 0 || onTokenSelect(aliasToken, 'alias');
        }
      }, /*#__PURE__*/_react.default.createElement(_icons2.Pick, {
        className: (0, _classnames.default)('token-panel-pro-token-pick', {
          'token-panel-pro-token-picked': selectedTokens === null || selectedTokens === void 0 || (_selectedTokens$alias = selectedTokens.alias) === null || _selectedTokens$alias === void 0 ? void 0 : _selectedTokens$alias.includes(aliasToken)
        })
      }))),
      key: aliasToken
...
var _default = exports.default = AliasPanel;