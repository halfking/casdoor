...
var TokenDetail = function TokenDetail(_ref) {
  ...
  var handleTokenChange = function handleTokenChange(theme) {
    return function (value) {
      ...
      (_theme$onThemeChange = theme.onThemeChange) === null || _theme$onThemeChange === void 0 || _theme$onThemeChange.call(theme, (0, _deepUpdateObj.default)(theme.config, [].concat((0, _toConsumableArray2.default)(path), [tokenName]), value), [].concat((0, _toConsumableArray2.default)(path), [tokenName]));
    };
  };
  ...
  }, (_tokenName2 = _tokenMeta.default.global[tokenName]) === null || _tokenName2 === void 0 ? void 0 : _tokenName2[locale._lang === 'zh-CN' ? 'desc' : 'descEn']), relatedComponents.length > 0 && /*#__PURE__*/_react.default.createElement(_antd.Tooltip, {
...
var _default = exports.default = TokenDetail;