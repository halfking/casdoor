...
var getHexValue = function getHexValue(value) {
  ...
  return alpha ? new _tinycolor.TinyColor(value).toHex8() : new _tinycolor.TinyColor(value).toHex();
};
...
var getColorStr = function getColorStr(color, mode) {
  switch (mode) {
    case 'HEX':
      return new _tinycolor.TinyColor(color).toHexString();
    case 'HEX8':
      return new _tinycolor.TinyColor(color).toHex8String();
    case 'RGBA':
    case 'RGB':
    default:
      return new _tinycolor.TinyColor(color).toRgbString();
  }
};
var ColorPanel = function ColorPanel(_ref3) {
  ...
  return wrapSSR( /*#__PURE__*/_react.default.createElement("div", {
    ...
    color: new _tinycolor.TinyColor(color).toHex(),
    ...
    color: new _tinycolor.TinyColor(color).toRgb(),
    onChange: function onChange(value) {
      _onChange(getColorStr(value, colorMode));
    }
  }), /*#__PURE__*/_react.default.createElement("div", {
    ...
    value: new _tinycolor.TinyColor(color).toHex(),
    onChange: function onChange(v) {
      return _onChange === null || _onChange === void 0 ? void 0 : _onChange(new _tinycolor.TinyColor(v).toHexString());
    }
  }), colorMode === 'HEX8' && /*#__PURE__*/_react.default.createElement(HexColorInput, {
    alpha: true,
    value: new _tinycolor.TinyColor(color).toHex8(),
    onChange: function onChange(v) {
      return _onChange === null || _onChange === void 0 ? void 0 : _onChange(new _tinycolor.TinyColor(v).toHex8String());
    }
  }), (colorMode === 'RGBA' || colorMode === 'RGB') && /*#__PURE__*/_react.default.createElement(RgbColorInput, {
    alpha: colorMode === 'RGBA',
    value: new _tinycolor.TinyColor(color).toRgb(),
    onChange: function onChange(v) {
      return _onChange === null || _onChange === void 0 ? void 0 : _onChange(new _tinycolor.TinyColor(v).toRgbString());
    }
  })), /*#__PURE__*/_react.default.createElement("div", {
