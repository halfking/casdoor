...
var useStyle = makeStyle('ComponentCard', function (token) {
  return _defineProperty({}, "".concat(token.rootCls, "-card.component-card"), _defineProperty(_defineProperty(_defineProperty({
    borderRadius: 6,
    boxShadow: "0 1px 2px 0 rgba(25,15,15,0.07)"
  }, "".concat(token.rootCls, "-card-head"), _defineProperty({
    paddingInline: 18
  }, "".concat(token.rootCls, "-card-head-title"), {
    paddingBlock: token.paddingSM,
    fontSize: token.fontSize
  })), "".concat(token.rootCls, "-card-body"), {
    padding: 18,
    overflow: 'auto'
