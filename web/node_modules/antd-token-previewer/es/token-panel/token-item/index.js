...
var useStyle = makeStyle('TokenItem', function (token) {
  return _defineProperty({}, "".concat(token.rootCls, "-collapse.previewer-token-item-collapse"), _defineProperty({}, ".previewer-token-item".concat(token.rootCls, "-collapse-item"), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({
    transition: "background-color ".concat(token.motionDurationSlow),
    borderRadius: {
      _skip_check_: true,
      value: "4px !important"
    }
  }, "&:not(".concat(token.rootCls, "-collapse-item-active):hover"), {
    backgroundColor: '#f5f5f5'
  }), "> ".concat(token.rootCls, "-collapse-header"), {
    padding: '12px 8px'
  }), "".concat(token.rootCls, "-collapse-header-text"), {
    flex: 1,
    width: 0
  }), "".concat(token.rootCls, "-collapse-content-box"), {
    padding: '0 4px'
...
export default (function (_ref4) {
  ...
  var handleTokenChange = function handleTokenChange(theme, value) {
    onTokenChange === null || onTokenChange === void 0 || onTokenChange(theme, tokenName, value);
  };
  ...
  return wrapSSR( /*#__PURE__*/React.createElement("div", {
    ...
    extra: enableTokenSelect ? /*#__PURE__*/React.createElement(ShowUsageButton, {
      ...
      toggleSelected: function toggleSelected() {
        onTokenSelect === null || onTokenSelect === void 0 || onTokenSelect(tokenName);
      }
    }) : undefined
