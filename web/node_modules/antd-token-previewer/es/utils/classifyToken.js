...
export var TOKEN_SORTS = defineTokenType(['seed', 'colorCommon', 'colorText', 'colorBg', 'colorFill', 'colorSplit', 'font', 'radius', 'space', 'screen', 'line', 'motion', 'control', 'others']);
export function getTypeOfToken(tokenName) {
...
export var classifyToken = function classifyToken(token) {
  var groupedToken = {};
