...
var useStyle = makeStyle('ThemeSelect', function (token) {
  return {
    '.previewer-theme-select': _defineProperty(_defineProperty({
      ...
      alignItems: 'center',
      overflow: 'hidden'
    }, "".concat(token.rootCls, "-btn.previewer-theme-select-add-btn"), {
      minWidth: 0,
      width: 16,
      height: 16,
      fontSize: 8,
