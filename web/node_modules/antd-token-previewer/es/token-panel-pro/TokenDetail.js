...
var TokenDetail = function TokenDetail(_ref) {
  ...
  var handleTokenChange = function handleTokenChange(theme) {
    return function (value) {
      ...
      (_theme$onThemeChange = theme.onThemeChange) === null || _theme$onThemeChange === void 0 || _theme$onThemeChange.call(theme, deepUpdateObj(theme.config, [].concat(_toConsumableArray(path), [tokenName]), value), [].concat(_toConsumableArray(path), [tokenName]));
    };
  };
  ...
  }, (_tokenName2 = tokenMeta.global[tokenName]) === null || _tokenName2 === void 0 ? void 0 : _tokenName2[locale._lang === 'zh-CN' ? 'desc' : 'descEn']), relatedComponents.length > 0 && /*#__PURE__*/React.createElement(Tooltip, {
