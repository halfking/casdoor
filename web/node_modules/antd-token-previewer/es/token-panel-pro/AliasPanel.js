...
var useStyle = makeStyle('TokenPanelProAlias', function (token) {
  return {
    '.token-panel-pro-color-alias': _defineProperty(_defineProperty({
      display: 'flex',
    ...
    }, ".token-panel-pro-alias-collapse".concat(token.rootCls, "-collapse"), _defineProperty(_defineProperty({}, "> ".concat(token.rootCls, "-collapse-item > ").concat(token.rootCls, "-collapse-content > ").concat(token.rootCls, "-collapse-content-box"), {
      paddingBlock: '0'
    }), "> ".concat(token.rootCls, "-collapse-item"), _defineProperty({}, "> ".concat(token.rootCls, "-collapse-header"), _defineProperty(_defineProperty({
      alignItems: 'center',
      padding: '8px 16px'
