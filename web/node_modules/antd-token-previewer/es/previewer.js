...
var useStyle = makeStyle('layout', function (token) {
  return _defineProperty({}, ".previewer-layout".concat(token.rootCls, "-layout"), _defineProperty(_defineProperty({}, "".concat(token.rootCls, "-layout-header"), {
  ...
  }), "".concat(token.rootCls, "-layout-sider"), _defineProperty(_defineProperty({
    padding: 0,
