...
import { BookFilled, BookOutlined, BulbOutlined, DownCircleFilled, DownOutlined, EllipsisOutlined, ExperimentFilled, FolderFilled, PlayCircleOutlined } from '@ant-design/icons';
import { Avatar, Button, Card, Col, List, Progress, Row, Space, Tag, theme, Typography } from 'antd';
import classNames from 'classnames';
import React from 'react';
import makeStyle from "../../../utils/makeStyle";
var useStyle = makeStyle('AppDemoDashboard', function (token) {
  return _defineProperty({}, token.componentCls, _defineProperty({}, "&-banner".concat(token.rootCls, "-card"), _defineProperty(_defineProperty(_defineProperty({
    ...
    '&::before': {
      ...
      top: 0,
      left: 0,
      backgroundImage: 'url(https://mdn.alipayobjects.com/huamei_7uahnr/afts/img/A*s3DrQKBGAI4AAAAAAAAAAAAADrJ8AQ/original)',
      filter: 'grayscale(100%)'
    }
  }, "".concat(token.componentCls, "-banner-title"), {
    fontSize: token.fontSizeHeading3,
    lineHeight: token.lineHeightHeading3,
    marginBottom: token.marginXS
  }), "".concat(token.componentCls, "-banner-guide"), {
    marginLeft: token.marginSM,
    '> *:not(:last-child)': {
      marginRight: token.marginXXS
    }
  }), "".concat(token.componentCls, "-banner-arrow"), {
    marginLeft: 'auto',
    fontSize: token.fontSizeHeading3
  })));
});
...
var helpList = ['语雀是什么', 'Ant Design 设计原则', '语雀数据安全', '如何使用 Ant Design Pro 模版', '数据可视化常见疑问点', '深入浅出解释 Ant Design Landing', 'Dumi 使用帮助', '如何参与体验一起造'];
var announcementList = [{
  ...
  tag: '更新',
  title: '蚂蚁金服设计平台用最小的作量，工作台常被作为应用的主页，是一个为用户提供便利的交通枢纽。工作台提供常用信息入口，以中心辐射的方式导航至应用的各功能模块；呈现用户当前需要关注的信息，缩短获取关键信息的路径；同时允许用户在工作台直接操作一些高频任务。',
  time: '1周前'
}, {
  tag: '平台',
  title: 'Ant Design 5.0 正式发布',
  time: '2周前'
}];
var favList = [{
  title: 'Ant Design',
  ...
  title: '查看全部',
  logo: /*#__PURE__*/React.createElement(EllipsisOutlined, null)
}];
var todoList = [{
  title: 'AntV 数据可视化',
  subtitle: '申请发布',
...
var recentList = [{
  ...
  icon: /*#__PURE__*/React.createElement(ExperimentFilled, {
    style: {
      color: '#1AC3C3',
      fontSize: 24
    }
...
var AntDesignDir = function AntDesignDir(_ref2) {
  ...
  }, /*#__PURE__*/React.createElement(FolderFilled, {
    style: {
...
var Dashboard = function Dashboard() {
  var prefixCls = 'app-demo-dashboard';
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "".concat(prefixCls, "-banner")
    ...
    className: "".concat(prefixCls, "-banner-title")
  }, "Hi\uFF0C\u6B22\u8FCE\u4F7F\u7528\u5E94\u7528 Paas \u5E73\u53F0\uFF01"), /*#__PURE__*/React.createElement(DownCircleFilled, {
    className: "".concat(prefixCls, "-banner-arrow")
  })), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", null, "\u8F7B\u677E\u521B\u5EFA\u3001\u90E8\u7F72\u548C\u7BA1\u7406\u4F60\u7684\u5E94\u7528\uFF0C\u63D0\u5347\u7814\u53D1\u6548\u7387\uFF0C\u964D\u4F4E\u4E1A\u52A1\u6210\u672C"), /*#__PURE__*/React.createElement("span", {
    className: "".concat(prefixCls, "-banner-guide")
  }, /*#__PURE__*/React.createElement(BookFilled, null), /*#__PURE__*/React.createElement("span", {
    style: {
      textDecoration: 'underline'
    }
  }, "\u5F00\u542F\u5F15\u5BFC")))), /*#__PURE__*/React.createElement(Row, {
    gutter: token.marginLG
    ...
    }, /*#__PURE__*/React.createElement("span", null, "\u4EE3\u529E\u4E8B\u9879"), /*#__PURE__*/React.createElement(Tag, {
      bordered: false,
      style: {
        marginLeft: 8,
        borderRadius: 6,
    ...
    dataSource: todoList,
    bordered: false,
    loadMore: /*#__PURE__*/React.createElement(Typography.Link, {
      disabled: true,
      style: {
        textAlign: 'center',
        display: 'block'
    ...
    renderItem: function renderItem(item) {
      ...
      }, item.title), /*#__PURE__*/React.createElement("span", null, item.subtitle)), /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: token.fontSizeSM,
          color: token.colorTextTertiary
        }
      }, /*#__PURE__*/React.createElement("span", null, item.author), /*#__PURE__*/React.createElement("span", {
        style: {
          marginInline: token.marginXXS
        }
      }, "\xB7"), /*#__PURE__*/React.createElement("span", null, item.time))), /*#__PURE__*/React.createElement(AntDesignDir, null), /*#__PURE__*/React.createElement(Button, {
        style: {
      ...
      }, item.status), /*#__PURE__*/React.createElement(DownOutlined, {
        style: {
    ...
    tabList: tabList,
    tabBarExtraContent: /*#__PURE__*/React.createElement(Button, null, "\u65B0\u5EFA"),
    bodyStyle: {
      paddingTop: token.padding,
      paddingBottom: token.paddingSM
    }
    ...
    renderItem: function renderItem(item, index) {
      return /*#__PURE__*/React.createElement(Card, {
        ...
        src: "https://xsgames.co/randomusers/avatar.php?g=pixel&key=".concat(index),
        style: {
          width: 16,
          height: 16,
      ...
      }, item.author)), /*#__PURE__*/React.createElement(AntDesignDir, {
        style: {
          marginRight: token.marginXL
        }
    ...
    renderItem: function renderItem(item, index) {
      return /*#__PURE__*/React.createElement(List.Item, {
      ...
      }, item.time), /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("span", null, item.creator), /*#__PURE__*/React.createElement("span", {
        style: {
          color: token.colorTextSecondary,
          marginInline: token.marginXXS
        }
      }, "\u7533\u8BF7\u8FED\u4EE3"), /*#__PURE__*/React.createElement("span", null, item.project), /*#__PURE__*/React.createElement("span", {
        style: {
          color: token.colorTextSecondary,
          marginInline: token.marginXXS
        }
      }, "\u53D1\u5E03")), item.logs && /*#__PURE__*/React.createElement(Card, {
        style: {
        ...
        bordered: false,
        bodyStyle: {
          padding: "".concat(token.paddingSM, "px ").concat(token.padding, "px")
        }
      }, item.logs.map(function (log) {
        return /*#__PURE__*/React.createElement("div", {
          key: log,
          style: {
            color: token.colorTextSecondary
    ...
    title: "\u6211\u7684\u6536\u85CF",
    bodyStyle: {
      paddingBottom: token.paddingLG - token.marginSM
    }
  }, /*#__PURE__*/React.createElement(List, {
    bordered: false,
    grid: {
    ...
    renderItem: function renderItem(item) {
      ...
      }, /*#__PURE__*/React.createElement("div", null, typeof item.logo === 'string' ? /*#__PURE__*/React.createElement(Avatar, {
        src: item.logo
      }) : /*#__PURE__*/React.createElement(Avatar, null, (_item$logo = item.logo) !== null && _item$logo !== void 0 ? _item$logo : item.title.slice(0, 1))), /*#__PURE__*/React.createElement("div", {
        style: {
          fontSize: token.fontSizeSM,
    ...
    title: "\u4F7F\u7528\u5E2E\u52A9",
    extra: /*#__PURE__*/React.createElement(Typography.Link, {
      disabled: true
    }, "\u66F4\u591A"),
    actions: [/*#__PURE__*/React.createElement(Button, {
      key: "prompt",
      type: "link",
      icon: /*#__PURE__*/React.createElement(BulbOutlined, null)
    }, "\u65B0\u624B\u5F15\u5BFC"), /*#__PURE__*/React.createElement(Button, {
      key: "demo",
      type: "link",
      icon: /*#__PURE__*/React.createElement(PlayCircleOutlined, null)
    }, "\u89C6\u9891\u6F14\u793A"), /*#__PURE__*/React.createElement(Button, {
      key: "docs",
      type: "link",
    ...
    dataSource: helpList,
    renderItem: function renderItem(item, index) {
      return /*#__PURE__*/React.createElement(Typography.Paragraph, {
        style: {
          marginBottom: index < 7 ? token.marginSM : 0
        }
      }, item);
    }
  })), /*#__PURE__*/React.createElement(Card, {
