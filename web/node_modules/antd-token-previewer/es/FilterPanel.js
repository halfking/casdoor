...
var useStyle = makeStyle('FilterPanel', function (token) {
  return {
    '.previewer-filter-panel': _defineProperty({
      // boxShadow:
...
var FilterPanel = function FilterPanel(_ref) {
  ...
  var _useStyle = useStyle(),
    ...
    hashId = _useStyle2[1];
  var _useMergedState = useMergedState(customFilterMode || 'filter'),
  ...
  }, rest), selectedTokens && selectedTokens.length > 0 && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: "component-tree-head"
  }, /*#__PURE__*/React.createElement("div", {
    className: "component-tree-filter-type"
  }, "\u7B5B\u9009\u65B9\u5F0F\uFF1A"), /*#__PURE__*/React.createElement(Segmented, {
    className: "component-tree-filter-segmented",
    size: "small",
    value: filterMode,
    onChange: function onChange(value) {
      onFilterModeChange === null || onFilterModeChange === void 0 || onFilterModeChange(value);
      setFilterMode(value);
    },
    options: [{
      label: '过滤',
