...
var category = [{
  ...
  groups: [{
    ...
    mapToken: (_seedRelatedMap$color = seedRelatedMap.colorTextBase) === null || _seedRelatedMap$color === void 0 ? void 0 : _seedRelatedMap$color.concat((_seedRelatedMap$color2 = seedRelatedMap.colorBgBase) !== null && _seedRelatedMap$color2 !== void 0 ? _seedRelatedMap$color2 : []),
    aliasToken: (_seedRelatedAlias$col = seedRelatedAlias.colorTextBase) === null || _seedRelatedAlias$col === void 0 ? void 0 : _seedRelatedAlias$col.concat((_seedRelatedAlias$col2 = seedRelatedAlias.colorBgBase) !== null && _seedRelatedAlias$col2 !== void 0 ? _seedRelatedAlias$col2 : []),
