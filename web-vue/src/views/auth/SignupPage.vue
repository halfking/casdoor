<template>
  ...
  <div v-else>
    ...
    <AgreementModal
      ...
      :content="termsOfUseContent || defaultTermsOfUse"
...
const defaultTermsOfUse = computed(() => {
  ...
  if (lang === 'zh') {
    ...
    return `
      ...
      <p>When using our AI services, please comply with following guidelines:</p>
      <ul>
      ...
      <p>By using this service, you agree to this agreement. We reserve right to modify this agreement at any time, and the modified agreement will be published on the website.</p>
    `;
  }
});
