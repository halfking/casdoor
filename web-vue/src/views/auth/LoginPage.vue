    ...
    <div :class="['login-panel', 'login-panel-split', isDark ? 'login-panel-dark' : '']">
      ...
      <div class="login-form">
        ...
        <AgreementModal
          ...
          :content="application?.termsOfUse || defaultTermsOfUse"
...
const defaultTermsOfUse = computed(() => {
  const lang = t('general:Language') === '中文' ? 'zh' : 'en';
  if (lang === 'zh') {
    return `
      <h2>用户协议</h2>
      <h3>1. 数据隐私</h3>
      <p>我们重视您的隐私权。您的个人数据将受到严格保护，仅用于提供和改进我们的服务。</p>
      <h3>2. 数据使用</h3>
      <p>我们可能会对您的数据进行脱敏处理，用于产品改进、服务优化和统计分析。脱敏后的数据将无法识别您的个人身份。</p>
      <h3>3. AI使用规范</h3>
      <p>在使用我们的AI服务时，请遵守以下规范：</p>
      <ul>
        <li>不得利用AI服务生成违法、有害或不当内容</li>
        <li>不得利用AI服务侵犯他人隐私或知识产权</li>
        <li>不得利用AI服务进行商业欺诈或其他违法行为</li>
        <li>用户对使用AI服务生成的内容承担全部责任</li>
      </ul>
      <h3>4. 服务条款</h3>
      <p>使用本服务即表示您同意本协议。我们保留随时修改本协议的权利，修改后的协议将在网站上公布。</p>
    `;
  } else {
    return `
      <h2>Terms of Use</h2>
      <h3>1. Data Privacy</h3>
      <p>We value your privacy. Your personal data will be strictly protected and used only to provide and improve our services.</p>
      <h3>2. Data Usage</h3>
      <p>We may anonymize your data for product improvement, service optimization, and statistical analysis. Anonymized data cannot identify your personal identity.</p>
      <h3>3. AI Usage Guidelines</h3>
      <p>When using our AI services, please comply with the following guidelines:</p>
      <ul>
        <li>Do not use AI services to generate illegal, harmful, or inappropriate content</li>
        <li>Do not use AI services to infringe on others' privacy or intellectual property</li>
        <li>Do not use AI services for commercial fraud or other illegal activities</li>
        <li>Users are fully responsible for content generated using AI services</li>
      </ul>
      <h3>4. Terms of Service</h3>
      <p>By using this service, you agree to this agreement. We reserve the right to modify this agreement at any time, and the modified agreement will be published on the website.</p>
    `;
  }
});
