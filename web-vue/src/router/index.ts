...
const managementRoutes: RouteRecordRaw[] = [
  ...
  { path: "/management/org-templates", name: "management-org-templates", component: () => import("@/views/management/OrgTemplateListPage.vue"), meta: { layout: "management", requiresAuth: true } },
  ...
  { path: "/management/sysinfo", name: "management-sysinfo", component: () => import("@/views/management/SystemInfoPage.vue"), meta: { layout: "management", requiresAuth: true, resourceKey: "systemInfo" } },
