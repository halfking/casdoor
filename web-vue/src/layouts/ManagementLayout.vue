    ...
    >
      <template #status-actions>
        ...
        <button
          ...
          @click="toggleTheme"
        >
          <span class="kx-shared-navbar__theme-toggle-icon" aria-hidden="true">
            <svg
            ...
            >
              ...
              <path d="M10 1.6v2.3M10 16.1v2.3M3.9 3.9l1.6 1.6M14.5 14.5l1.6 1.6M1.6 10h2.3M16.1 10h2.3M3.9 16.1l1.6-1.6M14.5 5.5l1.6-1.6" />
            </svg>
            <svg v-else viewBox="0 0 20 20" width="16" height="16" fill="currentColor">
              <path d="M13.1 2.4a7.8 7.8 0 1 0 4.5 13.8 8.1 8.1 0 1 1-4.5-13.8Z" />
            </svg>
          </span>
        </button>
      </template>
...
const menuItems = computed(() => {
  ...
  res.push({
    ...
    children: [
      { key: resolveMenuRoute("/organizations"), label: "租户管理" },
  ...
  res.push({
    ...
    children: [
      ...
      { key: "/management/org-templates", label: "模板管理" },
