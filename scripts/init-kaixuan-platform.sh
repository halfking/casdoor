...
# 执行：bash init-kaixuan-platform.sh
# 前提：Casdoor 在 192.168.31.28:9035 运行，postgres 容器运行中
# ============================================================================
set -euo pipefail

CASDOOR_HOST="192.168.31.28"
CASDOOR_PORT="9035"
PSQL="docker exec -i postgres psql -U casdoor -d casdoor"
